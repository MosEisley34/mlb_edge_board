...
function maybeNotifyDiscord_(cfg, oddsId, dateKey, payload) {
  ...
  var signalLogPayload = {
    ...
    unit_mxn: isFinite(sizingPlan.unit_mxn) ? round_(sizingPlan.unit_mxn, 2) : "",
    raw_stake_mxn: isFinite(sizingPlan.raw_stake_mxn) ? round_(sizingPlan.raw_stake_mxn, 2) : "",
    raw_to_win_mxn: isFinite(sizingPlan.raw_to_win_mxn) ? round_(sizingPlan.raw_to_win_mxn, 2) : "",
    recommended_stake_mxn: isFinite(sizingPlan.rec_stake_mxn) ? round_(sizingPlan.rec_stake_mxn, 2) : "",
    recommended_to_win_mxn: isFinite(sizingPlan.rec_to_win_mxn) ? round_(sizingPlan.rec_to_win_mxn, 2) : "",
    bucket_mxn: isFinite(sizingPlan.bet_bucket_mxn) ? round_(sizingPlan.bet_bucket_mxn, 2) : "",
    bucket_rounding: String(sizingPlan.bet_bucket_rounding || ""),
    min_bet_mxn: isFinite(sizingPlan.min_bet_mxn) ? round_(sizingPlan.min_bet_mxn, 2) : "",
    min_applied: sizingPlan.min_applied ? "Y" : "",
    sizing_mode: String(sizingPlan.sizing_mode || ""),
    sizing_note: String(sizingPlan.sizing_note || ""),
    model_risk_mxn: isFinite(sizingPlan.model_risk_mxn) ? round_(sizingPlan.model_risk_mxn, 2) : "",
    model_to_win_mxn: isFinite(sizingPlan.model_to_win_mxn) ? round_(sizingPlan.model_to_win_mxn, 2) : "",
    placed_risk_mxn: isFinite(sizingPlan.placed_risk_mxn) ? round_(sizingPlan.placed_risk_mxn, 2) : "",
    placed_to_win_mxn: isFinite(sizingPlan.placed_to_win_mxn) ? round_(sizingPlan.placed_to_win_mxn, 2) : "",
    min_applies_to: String(sizingPlan.min_applies_to || ""),
    delivery_status: "",
